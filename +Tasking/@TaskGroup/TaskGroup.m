    ...
    methods
        ...
        function obj = TaskGroup(varargin)
            ...
            if all(isTask)
                ...
                assert(~all(ischar(parameters)) || ...
                       mod(nargin - pvstart + 1, 2) ~= 0,...
                       [mfilename ':invalid_arguments'], [...
                       'Invalid input arguments. %s expects a list of ',...
                       'Tasking.Task() or Tasking.TaskGroup() objects, ',...
                       'optionally followed by parameter/value pairs.'],...
                       mfilename('class'));
                    ...
                    switch lower(parameter)
                        ...
                        case {'toplevel' 
                            ...
                            assert(isa(value, 'Tasking.Task'),...
                                   ...
                                   'Top-level task must be of type ',...
                                   'Tasking.Tasking.']);
        ...
        function set.hasTopTask(obj, tf)
            obj.hasTopTask = obj.checkDatatype('hasTopTask', tf,...
                                               'logical');
        ...
        function OK = execute(obj)
            ...
            if obj.hasTopTask
                ...
                assert(isscalar(doWork) && islogical(doWork),...
                      [mfilename ':invalid_datatype'], [...
                      'Output from top-level tasks must be ',...
                      'a scalar logical.']);
            end
